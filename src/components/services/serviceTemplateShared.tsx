...
import { PageSection, SectionHeading as PageSectionHeading } from "@/components/shared/PageSection";
...
export function ServiceDetail({
  ...
  return (
    <div className={`bg-background min-h-screen ${isFullFrameService ? "pt-0" : "pt-20"}`}>
      ...
      {isMbl && (
        <PageSection variant="light" className="py-20 md:py-24 border-b border-border">
      ...
      {isManufacturing && (
        <PageSection variant="light" dots className="py-20 md:py-24 border-b border-border">
          <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-16 items-center">
            <AnimatedSection className="max-w-3xl">
              <PageSectionHeading
                eyebrow="Overview"
