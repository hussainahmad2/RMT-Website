...
export const ALL_SERVICES: ServiceData[] = [
  ...
  },
  {
    ...
    subServices: [
      {
        ...
        tagline: "QMS development, audit readiness, CAPA, and operational quality.",
        overview: [
          "End-to-end QMS development, compliance consulting, audit readiness, and continuous improvement structured around ISO 13485.",
          "Covers document control, CAPA, risk management, validation support, batch review, complaint handling, and quality metrics.",
        ],
        keyPoints: ["ISO 13485 QMS design", "Audit & inspection readiness", "CAPA & risk management", "Batch release review", "Training programmes"],
        deliverables: ["QMS documentation", "Audit reports", "CAPA records", "Quality metrics dashboards"],
      },
      {
        slug: "qc-production",
    ...
    keywords: "quality department medical device, ISO 13485 QA, QC production testing, SaMD software quality, design control V&V, IEC 60601 testing",
