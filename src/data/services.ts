import {
  PRODUCT_DEVELOPMENT_CAPABILITIES,
  PRODUCT_DEVELOPMENT_INTRO,
  PRODUCT_DEVELOPMENT_TAGLINE,
} from "./product-development-content";
import {
  SQA_DELIVERABLES,
  SQA_KEY_HIGHLIGHTS,
  SQA_OVERVIEW,
...
export const ALL_SERVICES: ServiceData[] = [
  ...
  },
  {
    ...
    name: "Turnkey Product Development & Regulatory Consultancy",
    ...
    subServices: [
      {
        ...
        overview: [
          ...
          "Material selection, risk assessment, and commercial viability evaluation establish a sound foundation for vascular and interventional device programmes.",
        ],
        keyPoints: ["User needs & market assessment", "Design input definition", "Technical feasibility studies", "Material selection", "Risk assessment", "Commercial viability evaluation"],
        deliverables: ["Feasibility report", "Design input documentation", "Risk assessment summary", "Development roadmap"],
      },
      {
        ...
        overview: [
          ...
          "Design optimization and design-for-manufacturability ensure products are engineered for performance, cost, and scalable production.",
        ],
        keyPoints: ["Product architecture development", "Mechanical design & CAD modeling", "Design optimization", "Engineering analysis & simulations", "Design for Manufacturability (DFM)"],
        deliverables: ["Engineering drawings & CAD", "Simulation reports", "DFM review report", "Design documentation"],
      },
      {
        ...
        overview: [
          ...
          "Packaging development and manufacturing feasibility assessment prepare devices for verification and scale-up.",
        ],
        keyPoints: ["Rapid prototyping", "Functional prototype development", "Process development", "Design refinement & optimization", "Packaging development", "Manufacturing feasibility assessment"],
        deliverables: ["Functional prototypes", "Process development records", "Packaging concepts", "Feasibility assessment report"],
      },
      {
        ...
        overview: [
          ...
          "Packaging validation, sterilization validation support, and risk management activities ensure regulatory-ready products.",
        ],
        keyPoints: ["Design verification testing", "Functional & performance evaluation", "Reliability & durability testing", "Usability assessments", "Packaging & sterilization validation", "Risk management activities"],
        deliverables: ["V&V protocols & reports", "Usability evaluation records", "Validation summary", "Risk management documentation"],
      },
      {
        ...
        overview: [
          ...
          "Process validation support, supplier qualification, technology transfer, and production scale-up prepare your product for commercial launch.",
        ],
        keyPoints: ["Manufacturing process development", "Production documentation", "Assembly & inspection procedures", "Process validation support", "Supplier qualification", "Technology transfer & scale-up"],
        deliverables: ["DMR / production documentation", "Assembly & inspection procedures", "Validation protocols", "Scale-up plan"],
      },
      {
        ...
        overview: [
          ...
          "Technical documentation preparation, IQ/OQ/PQ validation services, product registration support, and regulatory strategy for global markets including FDA, CE, and DRAP.",
        ],
        keyPoints: ["ISO 13485 implementation", "ISO 14971 risk management", "Design control compliance", "Technical documentation", "Validation services (IQ/OQ/PQ)", "FDA, CE & DRAP registration support"],
        deliverables: ["QMS documentation", "Technical file / DHF", "Validation documentation", "Submission dossiers"],
      },
    ],
    capabilities: [...PRODUCT_DEVELOPMENT_CAPABILITIES],
    whyRMT: [
      { title: "Complete Turnkey Solutions", desc: "End-to-end product realization from concept through commercialization." },
      { title: "Vascular & Interventional Expertise", desc: "Stents, catheters, introducer sheaths, and disposable device development." },
    ...
    subServices: [
      ...
      },
      {
        ...
        keyPoints: [
          ...
          "Interventional catheters, microspheres, and guiding catheters",
        ],
      ...
      },
      {
        ...
        overview: [
          ...
          "ISO Class 05 suites support the most demanding production processes. ISO Class 07 environments balance accessibility with rigor for precision assembly. ISO Class 08 areas support material handling and workflow transitions under control.",
        ],
        keyPoints: [
          "ISO Class 05, 07, and 08 cleanrooms",
  ...
  {
    slug: "production-equipment-engineering",
    ...
    subServices: [
      {
        ...
        overview: [
          ...
          "We take a systems-level approach — considering the full production workflow, operator interaction, cleanroom compatibility, and downstream validation requirements before fabrication begins.",
        ],
        keyPoints: [
        ...
        deliverables: ["URS and concept design package", "Detailed engineering drawings", "Prototype build and FAT plan", "Design qualification (DQ) review"],
      },
      {
        slug: "production-line-development",
        name: "Production Line Development",
        tagline: "End-to-end manufacturing line setup, integration, and optimization.",
        overview: [
          "Building a medical device manufacturing line demands holistic understanding of product flow, process interdependencies, quality checkpoints, and regulatory compliance at every stage.",
          "We design, build, and integrate complete production lines optimized for throughput, yield, and compliance from the outset.",
        ],
        keyPoints: [
          "Line layout and workflow design",
          "Equipment integration and commissioning",
          "Capacity planning and throughput optimization",
          "Packaging line integration",
        ],
        deliverables: ["Line layout and facility plan", "Integration and commissioning report", "Throughput model and bottleneck analysis", "Packaging line validation support"],
      },
      {
        slug: "cleanroom-equipment-engineering",
        name: "Cleanroom Equipment Engineering",
        tagline: "Equipment designed and built to ISO Class 5–8 environment standards.",
        overview: [
          "Manufacturing equipment destined for ISO-classified cleanrooms demands contamination control as a primary design constraint — not an afterthought.",
          "Every surface, fastener, lubricant, and control enclosure is selected for cleanroom compatibility across ISO 5, 7, and 8 environments.",
        ],
        keyPoints: [
          "ISO 5, 7, and 8 cleanroom-compatible builds",
          "316L stainless steel and anodized aluminium construction",
          "Sealed enclosures and particle management by design",
          "ESD-safe materials for sensitive device manufacturing",
        ],
        deliverables: ["Cleanroom design specification", "Material compatibility matrix", "Installation qualification (IQ) protocol", "Cleaning validation support"],
      },
      {
        slug: "equipment-qualification-validation",
        name: "Equipment Qualification & Validation",
        tagline: "IQ, OQ, and PQ protocols developed and executed for regulatory readiness.",
        overview: [
          "Regulatory compliance for medical device manufacturing equipment is fundamental. Our qualification teams develop, execute, and document comprehensive IQ/OQ/PQ protocols aligned with FDA 21 CFR Part 820, ISO 13485, and GHTF/IMDRF guidance.",
          "We deliver a complete qualification package that withstands regulatory scrutiny — bridging equipment qualification to process validation.",
        ],
        keyPoints: [
          "Installation Qualification (IQ)",
          "Operational Qualification (OQ)",
          "Performance Qualification (PQ)",
          "URS, FRS, and DQ documentation",
          "Deviation log and CAPA documentation",
        ],
        deliverables: ["IQ/OQ/PQ protocols and reports", "Calibration traceability matrix", "Requalification schedule", "Change control procedures"],
      },
      {
        slug: "process-automation",
        name: "Process Automation",
        tagline: "Automated assembly, inspection, and handling systems for consistent output.",
        overview: [
          "Manual processes are a source of variability — and in medical device manufacturing, variability is the enemy of quality.",
          "Our automation engineering team designs and integrates intelligent, validated automation solutions that eliminate operator-dependent variation and generate the process data your quality system demands.",
        ],
        keyPoints: [
          "Vision-guided assembly and placement",
          "In-line inspection and leak/pressure testing",
          "Real-time process monitoring and SPC",
          "MES and QMS integration",
        ],
        deliverables: ["Automation concept and URS", "Validated control system design", "SPC and data capture configuration", "Operator training and documentation"],
      },
      {
        slug: "specialist-production-equipment",
        name: "Specialist Production Equipment",
        tagline: "Catheter forming, balloon bonding, micro-assembly, packaging, and cleaning systems.",
        overview: [
          "Medical device production encompasses highly specialized processes. Our engineering teams have deep expertise across the most demanding equipment categories in the industry.",
          "From catheter tubing shaping and balloon bonding to sterile barrier packaging and passivation systems — equipment informed by the reality of how it will be used.",
        ],
        keyPoints: [
          "Catheter tubing shaping and forming equipment",
          "Balloon forming and bonding stations",
          "Micro-assembly and fine-tolerance workstations",
          "Sterile barrier and packaging equipment (ISO 11607)",
          "Cleaning and passivation systems",
        ],
        deliverables: ["Equipment specification and design", "Process validation support", "FAT and SAT documentation", "Operator and maintenance manuals"],
      },
      {
        slug: "maintenance-calibration-support",
        name: "Maintenance, Calibration & Support",
        tagline: "Preventive maintenance programs, calibration, and technical field support.",
        overview: [
          "Equipment performance does not sustain itself. Our post-installation support programs keep manufacturing equipment performing at its qualified state — protecting product quality, production continuity, and regulatory compliance.",
          "Programs include planned preventive maintenance, traceable calibration, spare parts planning, and requalification support following maintenance or modification.",
        ],
        keyPoints: [
          "Planned preventive maintenance (PPM)",
          "Traceable instrument calibration (BIPM/NIST)",
          "Spare parts and critical inventory planning",
          "Requalification after maintenance or repair",
        ],
        deliverables: ["PPM schedule and records", "Calibration certificates and recall schedule", "Spare parts recommendations", "Requalification protocols"],
      },
    ],
    capabilities: [
      "Custom Equipment Design",
      "Production Line Development",
      "ISO 5–8 Cleanroom-Compatible Builds",
      "IQ / OQ / PQ Qualification",
      "Process Automation & Controls",
      "Specialist Medical Device Equipment",
      "FAT / SAT & Handover",
      "Maintenance & Calibration Support",
    ],
    whyRMT: [
      { title: "Purpose-Built for Medical Devices", desc: "Engineered from the ground up with cleanroom compatibility and regulatory validation as primary design inputs." },
      { title: "Validation-First Engineering", desc: "Qualification documentation developed in parallel with hardware — not added at the end." },
