...
export default function Gallery() {
  ...
  return (
    <div className="bg-background min-h-screen pt-20">
      ...
      {/* GALLERY GRID — masonry-like columns */}
            ...
            <AnimatePresence>
              {filtered.map((item, i) => (
                <motion.div
                  ...
                  className="break-inside-avoid mb-4 group relative overflow-hidden rounded-xl cursor-pointer border border-border hover:border-primary/50 hover:shadow-xl transition-all duration-300"
                  onClick={() => setLightbox(item)}
                >
                  <img src={item.thumb} alt={item.caption} className="w-full object-cover group-hover:scale-105 transition-transform duration-500 block" loading="lazy" />
